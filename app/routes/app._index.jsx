...
export default function SocialChatDashboard() {
  ...
  // Changed messages state to store messages per conversation id
  ...
  // Scroll chat to bottom on message update or conversation change
  useEffect(() => {
  ...
  // Reset Facebook data on Instagram connect and vice versa
  const resetFbData = () => {
    setFbPages([]);
  ...
  // WhatsApp connect fetch users & conversations
  ...
  // Send Facebook or Instagram message (simplified, you can expand)
  const sendFacebookMessage = async () => {
    ...
    try {
      ...
      const data = await res.json();
      console.log("Facebook/IG send response", data);
  ...
  // Get current conversation messages or empty
